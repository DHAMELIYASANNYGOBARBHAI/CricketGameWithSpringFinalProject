...
public class ScoreBordDetail {
    ...
    public ScoreBordDetail(int matchID, String team1Name, int scoreOfTeam1, int wicketLossOfTeam1, int oversPlayByTeam1,
                           String team2Name, int scoreOfTeam2, int wicketLossOfTeam2, int oversPlayByTeam2) {
